...
formal_param       : TLSBRACKET opt_formal_param TRSBRACKET       {semantic(17);};
...
compound_st       : TLMBRACKET opt_dcl_list opt_stat_list TRMBRACKET    {semantic(23);};
...
declarator       : TIDENT               {semantic(33);}
              | TIDENT TLLBRACKET opt_number TRLBRACKET      {semantic(34);};
...
while_st       : TWHILE TLSBRACKET expression TRSBRACKET statement    {semantic(51);};
...
multiplicative_exp    : unary_exp            {semantic(76);}
             | multiplicative_exp TSTAR unary_exp    {semantic(77);}
             | multiplicative_exp TSLASH unary_exp    {semantic(78);}
...
postfix_exp       : primary_exp            {semantic(85);}
               | postfix_exp TLLBRACKET expression TRLBRACKET    {semantic(86);}
               | postfix_exp TLSBRACKET opt_actual_param TRSBRACKET    {semantic(87);}
...
primary_exp       : TIDENT            {semantic(95);}
              | TNUMBER            {semantic(96);}
              | TLSBRACKET expression TRSBRACKET         {semantic(97);};
%%
